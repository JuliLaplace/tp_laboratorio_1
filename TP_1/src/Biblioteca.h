 ...
 * \param factorialA int valor de control para ver si se pudo realizar el factorial (1) o no se pudo realizar (0) de numA.
 * \param resulFactorialA int resultado de la funcion factorial de primer operando.
 * \param factorialB int valor de control para ver si se pudo realizar el factorial (1) o no se pudo realizar (0) de numB
 * \param resulFactorialB int resultado de la funcion factorial del segundo operando.
